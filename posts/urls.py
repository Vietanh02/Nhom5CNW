...
urlpatterns = [
    ...
    path(
        "webadmin/delete_features/<int:id>",
        views.delete_features,
    ...
    path(
        "webadmin/edit_curriculam/<int:id>",
        views.edit_curriculam,
        name="edit_curriculam",
    ),
    path(
        "webadmin/delete_curriculam/<int:id>",
        views.delete_curriculam,
        name="delete_curriculam",
    ),
    ...
    path(
        "webadmin/delete_subcatg/<int:id>", views.delete_subcatg, name="delete_subcatg"
    ),
    ...
    path(
        "webadmin/delete_admin_review/<int:id>",
        views.delete_admin_review,
        name="delete_admin_review",
    ),
    path(
        "webadmin/edit_admin_review/<int:id>",
        views.edit_admin_review,
    ...
    path(
        "certificate/<str:category_slug>/<str:slug>/",
        views.usercertificate,
        name="certificate",
    ),
    # Public urls
    ...
    path("checkoutpaypal/", views.paypal_check, name="checkoutpaypal"),
    path("paypal-return", views.paypal_return, name="paypal-return"),
    path("paypal-cancel", views.payal_cancel, name="paypal-cancel"),
